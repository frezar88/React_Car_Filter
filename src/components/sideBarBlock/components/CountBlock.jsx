...
const CountBlock = observer(() => {
    ...
    return (
        <div className={s.countBlock}>
            <div>
                <h6 style={{textAlign:'center', padding:'20px 0 0',background:'#fff',margin:0}}>Найдено {CarsStore.CarsList.filter((item)=>regionPrice==='price'? item.price >0:item).length} авто</h6>
