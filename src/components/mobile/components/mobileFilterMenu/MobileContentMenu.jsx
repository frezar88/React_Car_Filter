            ...
            <form onChange={debounceOnChangeForm}>
                {
                    FilterStore.modelFilter.length
                        ?
                        <AccordionBlock open={false} name={FilterStore.modelFilter[0].name}
                ...
                }
                {
                    FilterStore.modelFilter.length && FilterStore.CompleteSet.length
                        ? <AccordionBlock open={false} name={'Комплектация'} id={'completeSet'}>
                            {
                ...
                }
                {
                    FilterStore.yearFilter.length
                        ? <AccordionBlock open={false} name={FilterStore.yearFilter[0].name}
                                          id={FilterStore.modelFilter[0].id}>
                            {
                                FilterStore.modelFilter[0]['options'].length
                ...
                }
                {
                    FilterStore.priceFilter.length
                        ? <AccordionBlock open={false} name={FilterStore.priceFilter[0].name} id={FilterStore.priceFilter[0].id}>
                            <RangeSlider/>
                        </AccordionBlock>
                        :
                        false
                }
                {
                    FilterStore.engineFilter.length
                        ? <AccordionBlock open={false} name={FilterStore.engineFilter[0].name}
                ...
                }
                {
                    FilterStore.transmissionFilter.length
                        ?
                        <AccordionBlock open={false} name={FilterStore.transmissionFilter[0].name}
                ...
                }
                {
                    FilterStore.driveFilter.length
                        ?
                        <AccordionBlock open={false} name={FilterStore.driveFilter[0].name}
                ...
                }
                {
                    FilterStore.bodyFilter.length
                        ?
                        <AccordionBlock open={false} name={FilterStore.bodyFilter[0].name}
                ...
                }
                {
                    FilterStore.locationsFilter.length
                        ?
                        <AccordionBlock open={false} name={FilterStore.locationsFilter[0].name}
                ...
                }
                {
                    FilterStore.colorFilter.length
                        ?
                        <AccordionBlock open={false} name={FilterStore.colorFilter[0].name}
